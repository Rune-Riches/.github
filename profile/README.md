...
The platform is split across 12 repositories in the [Rune-Riches](https://github.com/Rune-Riches) GitHub organization:

### Applications

| Repository | Description |
|---|---|
| [**frontend-runeriches**](https://github.com/Rune-Riches/frontend-runeriches) | The player-facing casino web app — React 19, Vite, Tailwind CSS |
| [**admin-backoffice**](https://github.com/Rune-Riches/admin-backoffice) | The internal administration panel — React 19, Vite, Bootstrap 5 |

### Backend Services

| Repository | Description |
|---|---|
| [**user-service**](https://github.com/Rune-Riches/user-service) | Player accounts, authentication, profiles, KYC verification, VIP program, real-time chat, and notifications |
| [**game-service**](https://github.com/Rune-Riches/game-service) | Game catalog, session management, and Hub88 game provider integration (handles all bet/win/rollback transactions) |
| [**wallet-service**](https://github.com/Rune-Riches/wallet-service) | Coin balances, reward definitions, balance adjustments, and transaction ledger |
| [**payment-service**](https://github.com/Rune-Riches/payment-service) | Purchase and redemption processing via ApcoPay (cards) and NowPayments (crypto) |
| [**admin-service**](https://github.com/Rune-Riches/admin-service) | Back-office API powering the admin panel — reporting, automation rules, event logs, and the Chariot Ally AI assistant |

### Infrastructure & Tooling

| Repository | Description |
|---|---|
| [**brand-deployment**](https://github.com/Rune-Riches/brand-deployment) | AWS infrastructure as code (Terraform) — EKS Kubernetes cluster, networking, and CI/CD pipelines |
| [**status-service**](https://github.com/Rune-Riches/status-service) | Internal health monitoring dashboard — polls all services and displays a unified status page |
| [**api-doc-service**](https://github.com/Rune-Riches/api-doc-service) | API documentation service |
| [**load-testing**](https://github.com/Rune-Riches/load-testing) | k6 performance testing scripts for API endpoints |
| [**security-testing**](https://github.com/Rune-Riches/security-testing) | Security audit tooling and vulnerability testing |
...
|---|---|---|---|
| **Development** | [dev.runeriches.com](https://dev.runeriches.com) | [dev-admin.runeriches.com](https://dev-admin.runeriches.com) | Active development and testing |
| **Staging** | [staging.runeriches.com](https://staging.runeriches.com) | staging-admin.runeriches.com | Pre-production validation |
| **Production** | TBD | admin.runeriches.com | Live platform |

> **Note:** [runeriches.com](https://runeriches.com) currently serves a WordPress marketing/landing site, not the casino application.
